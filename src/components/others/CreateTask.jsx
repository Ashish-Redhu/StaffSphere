...
const CreateTask = () => {
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
            <form className='flex justify-between items-start flex-wrap w-full'>
                <div className='w-1/2'>
                    <div>
                ...
                <div className='w-1/2'>
                    ...
                    <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400 ' placeholder='Design a logo for the company' cols="30" rows="10"></textarea>
                    <button className='bg-emerald-500 py-3 hover:bg-emerald-600 rounded text-base mt-4 w-full font-semibold'>Create Task</button>
                </div>
            </form>
        </div>
  )
